...
\resumeEntryStart
    ...
    \resumeItemListStart
      ...
      \resumeItemListEnd
      \resumeItem {Angular, TypeScript, Node.JS, MongoDB, CSS, Express, Ionic, Docker, Google API, MapBox, Stripe, Firebase.}
    \resumeItemListEnd
    ...
    \resumeEntryTSDL
        ...
        {Full Stack}{Contract}
    \resumeItemListStart
      \resumeItem {Designing and developing a modern business website to showcase client offerings and improve online presence.}
      \resumeItemListStart
        \resumeItem {Optimizing the site for performance, SEO, and mobile responsiveness.} 
        \resumeItem{Managing hosting and deployment for a performant and reliable user experience.}
      \resumeItemListEnd
      \resumeItem {React, TypeScript, HTML, CSS, Astro}
    \resumeItemListEnd
...
\section{\faGears}{Skills}
 \resumeEntryStart
  ...
  \resumeEntryS{Frameworks \& Databases} {Node.JS, Angular, React, MongoDB, Django, PostgreSQL, MySQL, Ionic}
